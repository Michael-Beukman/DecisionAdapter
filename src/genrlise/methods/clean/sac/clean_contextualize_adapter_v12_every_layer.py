...
from genrlise.methods.clean.sac.networks.good_adapters import AdapterActorContextualizeEveryLayer, AdapterCriticContextualizeEveryLayer

K = 205
class CleanSACContextualizeAdapterV12EveryLayer(CleanSACAdapterV1):
    def _get_actor_class(self):
        return AdapterActorContextualizeEveryLayer

    def _get_critic_class(self):
        return AdapterCriticContextualizeEveryLayer
    ...
    def _get_actor_kwargs(self, kwargs): 
        ...
        print(f"In actor kwargs, {kwargs=}")
        return kwargs
    ...
    def load_method_from_file(self, filename: str):
        print("Here I am loading a model from file")
